            ...
            <div className="container mx-auto py-4 flex flex-col gap-4">
              {navLinks.map((link) => (
                <a
                  ...
                  className="text-hero-foreground/80 hover:text-primary transition-colors py-2"
                >
                  {link.label}
                </a>
              ))}
              <a
                href="#contact"
                onClick={() => setMobileOpen(false)}
                className="gradient-bg text-primary-foreground font-semibold text-sm px-6 py-2.5 rounded-lg text-center"
              >
                Get Started
              </a>
            </div>
